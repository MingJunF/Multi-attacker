...
class MAPPO_Potential(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, num_agents, device=torch.device("cpu")):
        ...
        self.potential_weight = args.get("potential_weight", 0.1)
        self.exploration_bonus_weight = args.get("exploration_bonus_weight", 0.02)
    ...
    def update(self, sample):
        ...
        adv_targ = adv_targ + self.potential_weight * (next_v - current_v)

...
class OnPolicyBaseRunner:
    ...
    def __init__(self, args, algo_args, env_args):
        ...
        if self.share_param:
            self.actor = []
            if self.args["algo"] == "mappo_potential":
            ...
            self.actor = []
            if self.args["algo"] == "mappo_potential" or self.args["algo"] == "happo_potential" or self.args["algo"] == "hatrpo_potential":
        ...
        if self.algo_args["render"]["use_render"] is False:  # train, not render
            ...
            #new add Jianglin
            if self.args["algo"] == "mappo_potential" or self.args["algo"] == "happo_potential" or self.args["algo"] == "hatrpo_potential" and self.state_type == "EP":
